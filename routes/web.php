...
use App\Http\Controllers\VenderVacationsController;
use App\Http\Controllers\AllVacations;
use App\Http\Controllers\AccountantVacations;
...
require __DIR__.'/auth.php';
                                       ...
                                       //vender vacation//
Route::resource('/venderVacation',VenderVacationsController::class)->middleware('auth:vender');

                                          //accountantVacatoon//
Route::resource('accountantVacation',AccountantVacations::class)->middleware(['auth','XSS','revalidate']);

                                           //AllVacations//

Route::resource('allVacations',AllVacations::class)->middleware(['auth','XSS','revalidate']);
