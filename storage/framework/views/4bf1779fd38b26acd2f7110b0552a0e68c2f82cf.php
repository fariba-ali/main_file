                ...
                <table class="table table-borderless text-center " style="direction: rtl">
                    ...
                    <?php $__currentLoopData = $venderVacations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venderVacation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e(number_format($venderVacation->untilH-$venderVacation->fromH)); ?></td>
                            <td><?php echo e($venderVacation->firstDay); ?></td>
                            <td><?php echo e($venderVacation->lastDay); ?></td>
                            <td><?php echo e(number_format($venderVacation->lastDay-$venderVacation->firstDay)); ?></td>
                            <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\main_file\resources\views/vender/vacation/index.blade.php ENDPATH**/ ?>