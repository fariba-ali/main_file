    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="dash-navbar">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage vacation')): ?>
                    <li  class="dash-item <?php echo e((Request::route()->getName() == 'allVacations.index' || Request::route()->getName() == 'allVacations.edit') ? ' active' : ''); ?>">
                        <a href="<?php echo e(route('allVacations.index')); ?>" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-circle-plus"></i></span>
                            <?php echo e(__('All vacations')); ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create vender vacation')): ?>
                   <li  class="dash-item <?php echo e((Request::route()->getName() == 'venderVacation.index' || Request::route()->getName() == 'VenderVacation.edit') ? ' active' : ''); ?>">
                    <a href="<?php echo e(route('venderVacation.index')); ?>" class="dash-link">
                        <span class="dash-micon"><i class="ti ti-circle-plus"></i></span>

                        <?php echo e(__('Vender vacations')); ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage accountant vacation')): ?>
                    <li  class="dash-item <?php echo e((Request::route()->getName() == 'accountantVacation.index' || Request::route()->getName() == 'accountantVacation.edit') ? ' active' : ''); ?>">
                        <a href="<?php echo e(route('accountantVacation.index')); ?>" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-circle-plus"></i></span>

                            <?php echo e(__('accountant vacations')); ?>
...
<?php /**PATH C:\xampp\htdocs\main_file\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>