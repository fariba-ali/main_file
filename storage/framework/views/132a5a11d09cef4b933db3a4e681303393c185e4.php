...
<?php $__env->startSection('content'); ?>
    <div class="card ">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(isset($venderVacation)? route('venderVacation.update',$venderVacation->id): route('venderVacation.store')); ?>" method="post" >
                <?php echo csrf_field(); ?>
                <?php if(isset($venderVacation)): ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="fromh" aria-describedby="emailHelp"
                           name="fromH" value="<?php echo e(isset($venderVacation) ? $venderVacation->fromH : ''); ?> ">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="untilh" aria-describedby="emailHelp"
                           name="untilH" value="<?php echo e(isset($venderVacation) ? $venderVacation->untilH : ''); ?> ">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="firstday" aria-describedby="emailHelp"
                           name="firstDay" value="<?php echo e(isset($venderVacation) ? $venderVacation->firstDay : ''); ?>">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="lastday" aria-describedby="emailHelp"
                           name="lastDay" value="<?php echo e(isset($venderVacation) ? $venderVacation->lastDay : ''); ?>">
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\main_file\resources\views/vender/create.blade.php ENDPATH**/ ?>
