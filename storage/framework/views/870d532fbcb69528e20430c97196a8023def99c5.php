                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="vendername" aria-describedby="emailHelp"
                               name="vender_name" value="<?php echo e($vacation->vender_name); ?> ">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="venderid" aria-describedby="emailHelp"
                               name="vender_id" value="<?php echo e($vacation->vender_id); ?> " >
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="accountantname" aria-describedby="emailHelp"
                               name="accountant_name" value="<?php echo e($vacation->accountant_name); ?> " >
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="accountantid" aria-describedby="emailHelp"
                               name="accountant_id" value="<?php echo e($vacation->accountant_id); ?> " >
                    </div>
