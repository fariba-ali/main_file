...
<?php $__env->startSection('content'); ?>
    <div class="card ">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(isset($accountVacation)? route('accountantVacation.update',$accountVacation->id) : route('accountantVacation.store')); ?>" method="post" >
                <?php echo csrf_field(); ?>
                <?php if(isset($accountVacation)): ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="fromh" aria-describedby="emailHelp"
                           name="fromH" value="<?php echo e(isset($accountVacation) ? $accountVacation->fromH : ''); ?> ">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="untilh" aria-describedby="emailHelp"
                           name="untilH" value="<?php echo e(isset($accountVacation) ? $accountVacation->untilH : ''); ?> ">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="firstday" aria-describedby="emailHelp"
                           name="firstDay" value="<?php echo e(isset($accountVacation) ? $accountVacation->firstDay : ''); ?>">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="lastday" aria-describedby="emailHelp"
                           name="lastDay" value="<?php echo e(isset($accountVacation) ? $accountVacation->lastDay : ''); ?>">
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\main_file\resources\views/accountantVacation/create.blade.php ENDPATH**/ ?>