            ...
            <ul class="dash-navbar">
                ...
                @can('manage vacation')
                    <li  class="dash-item {{ (Request::route()->getName() == 'allVacations.index' || Request::route()->getName() == 'allVacations.edit') ? ' active' : '' }}">
                        <a href="{{route('allVacations.index')}}" class="dash-link">
                ...
                {{--                accountant vacation--}}
                @can('manage accountant vacation')
                    <li  class="dash-item {{ (Request::route()->getName() == 'accountantVacation.index' || Request::route()->getName() == 'accountantVacation.edit') ? ' active' : '' }}">
                        <a href="{{route('accountantVacation.index')}}" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-circle-plus"></i></span>

                            {{ __('accountant vacations') }}
                        </a>
                    </li>
                @endcan
