            ...
            <ul class="dash-navbar">
                ...
                <li class="dash-item ">
                    ...
                    @endif
                                 ...
                                 {{-- vacation--}}
                @can('manage allVacations')
                    <li class="dash-item {{ (Request::route()->getName() == 'allVacations.index' || Request::route()->getName() == 'allVacations.edit') ? ' active' : '' }}">
                        <a class="dash-link" href="{{ route('allVacations.index') }}">
                ...
                @endcan
                          ...
                          {{--                user vacation--}}
                @if( Gate::check('manage userVacation') )
                @can('manage userVacation')
                    <li class="dash-item {{ (Request::route()->getName() == 'userVacation.index' || Request::route()->getName() == 'userVacation.edit') ? ' active' : '' }}">
                        <a class="dash-link" href="{{ route('userVacation.index') }}">
                            <span class="dash-micon"><i class="ti ti-circle-plus"></i></span>
                            {{ __('user allVacations') }}</a>
                    </li>
                @endcan
                @endif
                ...
                @if( Gate::check('manage vender vacation') )
                    @can('manage vender vacation')
                        <li class="dash-item {{ (Request::route()->getName() == 'venderVacation.index' || Request::route()->getName() == 'VenderVacation.edit') ? ' active' : '' }}">
                            <a class="dash-link" href="{{ route('venderVacation.index') }}">
                                <span class="dash-micon"><i class="ti ti-circle-plus"></i></span>
                                {{ __('vender allVacations') }}</a>
                        </li>
                    @endcan
                @endif
